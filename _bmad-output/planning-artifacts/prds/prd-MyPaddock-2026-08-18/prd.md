...
| **QO-4** | **Le moteur de synchronisation se tranche à `bmad-architecture`**, sur critères écrits. | Quatre candidats vivants, Legend-State écarté pour l'échéance de décembre. **Et le périmètre technique s'élargit** : voir QO-6, qui introduit un service serveur là où il n'y en avait pas. |
