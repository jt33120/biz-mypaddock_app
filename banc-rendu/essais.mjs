...
const BOUT_EN_BOUT = [
  ...
  'fumee-confirmation', 'fumee-journee', 'fumee-photo', 'fumee-recap', 'fumee-circuit', 'fumee-emport', 'fumee-portrait', 'fumee-atelier', 'fumee-machine', 'fumee-legal', 'fumee-vide-saisonnier', 'fumee-courbe', 'fumee-usure', 'fumee-checklist', 'fumee-saison', 'fumee-cercle',
]
