...
const BOUT_EN_BOUT = [
  ...
  'fumee-confirmation', 'fumee-journee', 'fumee-chute', 'fumee-video', 'fumee-tenue', 'fumee-preparation', 'fumee-a-venir', 'fumee-photo', 'fumee-coffre', 'fumee-recap', 'fumee-circuit', 'fumee-circuit-fiche', 'fumee-emport', 'fumee-portrait', 'fumee-atelier', 'fumee-budget', 'fumee-machine', 'fumee-legal', 'fumee-vide-saisonnier', 'fumee-courbe', 'fumee-usure', 'fumee-checklist', 'fumee-saison', 'fumee-cercle', 'fumee-destructif',
]
