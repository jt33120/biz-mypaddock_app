// ⚠ SOURCE UNIQUE DU PROMPT DE PRODUCTION. Ce fichier vit DANS LA FONCTION
// SERVEUR et nulle part ailleurs, pour deux raisons qui tiennent chacune seule :
//
...
//
// Le banc de rendu (`banc-rendu/prompts/v6-pixel-production.js`) le RÉEXPORTE :
// il ne le recopie pas.
//
