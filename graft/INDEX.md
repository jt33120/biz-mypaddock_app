...
- [vite.config](vite.config.md) — vite.config

## Files

151 per-file wiring cards mirror the source tree under `graft/` (137 carry extracted symbols). They are deliberately not enumerated here —
